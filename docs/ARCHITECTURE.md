...
**Programm-Kontingente** (Scope `quota`) erlauben ein Programm für eine Anzahl Minuten pro lokalem Tag. Der Agent meldet, ob der Prozess läuft. Ist das Kontingent aufgebraucht, wird der Prozess beendet, die restliche Sitzung bleibt davon unberührt.
